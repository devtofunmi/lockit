...
const MessagePage = () => {
  ...
  useEffect(() => {
    ...
    const fetchAndDecrypt = async () => {
      try {
        const res = await fetch(`https://lockit.up.railway.app/message/${messageId}`);
    ...
    <div className="min-h-screen bg-gray-800 text-gray-900 px-4 py-6 flex flex-col items-center justify-center">
      ...
      {error ? (
        ...
        <div className="flex justify-center items-center">
          <svg className="h-12 w-12 animate-spin text-white" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
  <circle
